              ...
              <SelectControl
                ...
                options={
                  [
                    ...
                    { label: __( 'Coverflow', 'grayscale' ), value: 'coverflow' },
                    { label: __( 'Creative', 'grayscale' ), value: 'creative' },
                    { label: __( 'Cards', 'grayscale' ), value: 'cards' },
                  ]
                }
